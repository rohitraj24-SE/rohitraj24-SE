...
# ===========================================================================
HOST = "rohit"   # shown as  rohit@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Student"),
    ("kv", "Goal", "Backend & Full Stack Developer"),
    ("kv", "Interest", "AI & Cloud"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Backend", "Java, Node.js, REST APIs"),
    ("kv", "Frontend", "HTML, CSS, JavaScript"),
    ("kv", "AI / ML", "Python, exploring AI tooling"),
    ("kv", "Cloud", "AWS basics, Docker"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Aspiring backend & full stack developer"),
    ("bul", "AI & cloud enthusiast, always learning"),
]
